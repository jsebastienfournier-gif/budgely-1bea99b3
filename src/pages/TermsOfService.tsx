...
const TermsOfService = () => (
  <div className="min-h-screen bg-background">
    <PageMeta
      title="Conditions générales d'utilisation — Budgely"
      description="Conditions générales d'utilisation du service Budgely : inscription, formules, responsabilités et résiliation."
      path="/cgu"
    />
